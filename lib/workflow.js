...
function getActionFallbackLines(actionId) {
  if (ACTION_FALLBACK_LINES[actionId]) return [...ACTION_FALLBACK_LINES[actionId]];
  if (MUTATION_HEAVY_ACTION_IDS.has(actionId)) return [...DEFAULT_MUTATION_FALLBACK_LINES];
  return [...DEFAULT_NON_MUTATION_FALLBACK_LINES];
}

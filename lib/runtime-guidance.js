...
function buildStatus(options = {}) {
  ...
  return {
    ...
    active: {
      taskGroup: Object.prototype.hasOwnProperty.call(persisted.active, 'taskGroup') ? persisted.active.taskGroup : null,
      nextTaskGroup: Object.prototype.hasOwnProperty.call(persisted.active, 'nextTaskGroup') ? persisted.active.nextTaskGroup : null
    },
    warnings: persisted.warnings.slice(),
    blockers: persisted.blockers.slice(),

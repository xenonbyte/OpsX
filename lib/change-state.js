...
function normalizeState(state) {
  ...
  return {
    ...source,
    stage: STAGE_SET.has(normalizedStage) ? normalizedStage : 'INIT',
    active: {
      ...active
    }
  };
...
const TRANSITIONS = Object.freeze({
  ...
  TASKS_READY: Object.freeze({
    [MUTATION_EVENTS.START_TASK_GROUP]: (state, event) => ({
      ...
      active: {
        ...(state.active || {}),
        taskGroup: resolveTaskGroupFromState(state, event) || null,
  ...
  GROUP_VERIFIED: Object.freeze({
    [MUTATION_EVENTS.START_TASK_GROUP]: (state, event) => ({
      ...
      active: {
        ...(state.active || {}),
        taskGroup: resolveTaskGroupFromState(state, event) || resolveNextTaskGroupFromState(state, event) || null,
        nextTaskGroup: resolveNextTaskGroupFromState(state, event) || null
      }
    }),

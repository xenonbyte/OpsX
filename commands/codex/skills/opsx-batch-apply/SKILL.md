---
name: opsx-batch-apply
description: "Apply multiple ready changes in a controlled sequence."
---
# OpsX route: Batch apply

Use this `opsx-batch-apply` skill for this request. The shared OpsX workflow contract is embedded below, and detailed templates live in `references/` next to this file.
...
Execution rules:
- Follow the `batch-apply` playbook from shared OpsX guidance and its referenced files.

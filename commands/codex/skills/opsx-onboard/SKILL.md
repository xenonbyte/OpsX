---
name: opsx-onboard
description: "Walk a user through the minimum OpsX workflow path."
---
# OpsX route: Onboard

Use this `opsx-onboard` skill for this request. The shared OpsX workflow contract is embedded below, and detailed templates live in `references/` next to this file.
...
Execution rules:
- Follow the `onboard` playbook from shared OpsX guidance and its referenced files.
